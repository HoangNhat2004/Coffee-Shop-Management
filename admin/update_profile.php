...
if (isset($_POST['submit'])) {
   ...
   $empty_pass = 'da39a3ee5e6b4b0d3255bfef95601890afd80709'; // SHA-1 hash for an empty string
   ...
   if (!empty($old_pass) && $old_pass != $empty_pass) {
      if ($old_pass != $prev_pass) {
         ...
         // Only update username after successful password change
         if (!empty($name)) {
      ...
      $message[] = 'Please enter your old password to update profile!';
   }
}
?>
