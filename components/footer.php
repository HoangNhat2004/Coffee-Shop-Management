 <footer class="footer">
    ...
    <section class="grid">
       ...
       <div class="box">
          ...
          <div class="phone1">
             ...
             <p> <i class="fas fa-map-marker-alt"></i> Cà phê công đoàn </p>
             <p> <i class="fas fa-envelope"></i> cafe.shop@gmail.com </p>
          </div>
       </div>
    ...
    <div class="credit">&copy; copyright @ <?= date('Y'); ?> by <span></span> | <a>Software Engineering (Group:6)</a> | all rights reserved!</div>
